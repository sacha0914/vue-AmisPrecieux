...
<template>
    ...
    <p>2023 ©  Amis Précieux | Privacy Policy</p>
   <a href="https://www.instagram.com/amisprecieux_/" target="_blank"> <font-awesome-icon icon="fa-brands fa-instagram" size="2xl" style="color: #2D3344;
;" /></a>
</div>
</template>
